    		...
    		<table>
				<tr>
					...
					<td class="text-content">
						<input type="hidden" name="taskVo.creatorUserid" value="${taskVo.creatorUserid }">
				...
				<tr>
					...
					<td class="text-content">
						<input type="hidden" name="taskVo.ownerUserid value="${taskVo.ownerUserid }">
				...
				<tr style="display:${empty taskVo ? 'table-row' : 'none'};">
					...
					<td class="text-content">
						<input type="hidden" name="taskVo.DeleteUserid" value="${taskVo.deleteUserid }"/>
